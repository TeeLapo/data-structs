    ...
    while (option != 5) {
        ...
        switch(option) {
            case 1: {
                ...
                if (scanf("%19s", customer.customerFirstName) != 1) {
                    if (feof(stdin)) {
                        printf("\nEOF reached. Exiting program.\n");
                ...
                if (scanf("%19s", customer.customerLastName) != 1) {
                    if (feof(stdin)) {
                        printf("\nEOF reached. Exiting program.\n");
                        list_destroy(customerList);
                        return 0;
                ...
                while (1) {
                    ...
                    if (scanf("%21s", confirmPassword) != 1) {
                        if (feof(stdin)) {
                            printf("\nEOF reached. Exiting program.\n");
                            list_destroy(customerList);
                            return 0;
            ...
            case 2: {
                ...
                if (scanf("%11s", customerIDCheck) != 1) {
                    if (feof(stdin)) {
                        printf("\nEOF reached. Exiting program.\n");
                        list_destroy(customerList);
                        return 0;
            ...
            case 4: {
                ...
                if (scanf("%d", &transactionOption) != 1) {
                    if (feof(stdin)) {
                        printf("\nEOF reached. Exiting program.\n");
                        list_destroy(customerList);
                        return 0;
